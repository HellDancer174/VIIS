...
{
    public class ViewNewMasterCashDetail : ViewNewDetail<ViewMasterCashList, ViewMasterCash, MasterCash>
    {
        public ViewNewMasterCashDetail(ViewMasterCashList repository, List<ViewEmployee> masters): 
